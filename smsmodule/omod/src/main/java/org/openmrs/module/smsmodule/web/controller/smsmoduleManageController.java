 ...
 */
package org.openmrs.module.smsmodule.web.controller;
 ...
 */
@Controller
public class  smsmoduleManageController {
	
	protected final Log log = LogFactory.getLog(getClass());
	
	@RequestMapping(value = "/module/smsmodule/manage", method = RequestMethod.GET)
	...
	public void storingOutbound(@RequestParam(value="cellnum", required=true)String[] m, @RequestParam(value="txtMsg", required=true)String message,
		...
		for (String recipient : m) {
			...
			smsservice.createNewOutboundSms(recipient, message, new Date(), Priority.HIGH, validityPeriod, patientid , org.openmrs.module.smsmodule.OutboundMessage.PeriodType.HOUR, 1, "");
		}
